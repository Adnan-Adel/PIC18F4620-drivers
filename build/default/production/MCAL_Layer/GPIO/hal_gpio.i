...
std_ReturnType gpio_pin_get_direction_status(const pin_config_t *pin_config, direction_t *direction_status)
{
    ...
    {
        *direction_status= ((*tris_registers[pin_config->port] >> pin_config->pin) & 0x01);
    }
    return ret_val;
}
...
# 112 "MCAL_Layer/GPIO/hal_gpio.c"
std_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config, logic_t *logic_value)
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
    if((((void*)0) == pin_config) || (((void*)0) == logic_value) || (pin_config->pin > 8 -1))
    {
        ret_val= (std_ReturnType)0x00;
    }
    else
    {
        *logic_value= ((*port_registers[pin_config->port] >> pin_config->pin) & 0x01);
    }
    return ret_val;
}
...
# 154 "MCAL_Layer/GPIO/hal_gpio.c"
std_ReturnType gpio_pin_initialize(const pin_config_t *pin_config)
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
    if(((void*)0) == pin_config || pin_config->pin > 8 -1)
...
# 205 "MCAL_Layer/GPIO/hal_gpio.c"
std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8_t *direction_status)
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
...
# 227 "MCAL_Layer/GPIO/hal_gpio.c"
std_ReturnType gpio_port_write_logic(port_index_t port, uint8_t logic)
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
    if(port > 5 -1)
...
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
    if((((void*)0) == logic_value) || (port > 5 -1))
    {
        ret_val= (std_ReturnType)0x00;
    }
    else
...
# 270 "MCAL_Layer/GPIO/hal_gpio.c"
std_ReturnType gpio_port_toggle_logic(port_index_t port)
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
    if(port > 5 -1)
