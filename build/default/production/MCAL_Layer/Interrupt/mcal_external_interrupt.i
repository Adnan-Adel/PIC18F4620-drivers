...
void INT1_ISR(void)
{
    ...
    if(INT1_InterruptHandler != ((void*)0))
    {
...
std_ReturnType Interrupt_RBx_Init(const Interrupt_RBx_t *int_obj)
{
    ...
    else
    {
        ...
        (INTCONbits.RBIF = 0);
# 164 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 351 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
# 368 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
# 450 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static std_ReturnType Interrupt_INTx_Edge_Init(const Interrupt_INTx_t *int_obj)
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
    if(((void*)0) == int_obj)
...
# 629 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static std_ReturnType Interrupt_RBx_Pin_Init(const Interrupt_RBx_t *int_obj)
{
    std_ReturnType ret_val= (std_ReturnType)0x01;
    if(((void*)0) == int_obj)
